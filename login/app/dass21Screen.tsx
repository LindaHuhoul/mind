...
const Dass21Screen = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Assessment: DASS 21</Text>
      ...
      {page === 1 && (
        <>
          ...
          {renderQuestion(3, "I couldn't seem to experience any positive feeling at all")}
          {renderQuestion(4, 'I experienced breathing difficulty (e.g., excessively rapid breathing, breathlessness in the absence of physical exertion)')}
          {renderQuestion(5, 'I found it difficult to work up the initiative to do things')}
        </>
      )}
      ...
      {page === 2 && (
        <>
          ...
          {renderQuestion(9, 'I was worried about situations in which I might panic and make a fool of myself')}
      ...
      {page === 3 && (
        <>
          ...
          {renderQuestion(14, 'I was intolerant of anything that kept me from getting on with what I was doing')}
      ...
      {page === 4 && (
        <>
          {renderQuestion(16, 'I was unable to become enthusiastic about anything')}
          {renderQuestion(17, 'I felt I wasn’t worth much as a person')}
          {renderQuestion(18, 'I felt that I was rather touchy')}
          {renderQuestion(19, 'I was aware of the action of my heart in the absence of physical exertion (e.g., sense of heart rate increase, heart missing a beat)')}
